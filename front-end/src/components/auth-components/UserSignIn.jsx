...
export const UserSignIn = () => {
    ...
    const [userDetails, setUserDetails] = useState({ name: "", phone: "", password: "", confirmPw: "" });
    const [focused, setFocused] = useState({ name: false, phone: false, password: false, confirmPw: false });
    ...
    const handleUserSignIn = async () => {
        ...
        try {
            const response = await axios.post(`${import.meta.env.VITE_API_URL}/signin`, { userDetails });
                ...
                <div className="row justify-content-center">
                    <div className="col-12 col-md-6">
                        <div className="auth-container">
                            <h2 className="text-center auth-title">User Sign-In</h2>
                            <form onSubmit={(e) => { e.preventDefault(); handleUserSignIn(); }}>
